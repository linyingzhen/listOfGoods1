<template lang="html">
    <div class="dggbox">
        <div class="dgg" :class="{dgg2show:Descshow}">
            ...
            <div class="dgg-total">
                <span class="dgg-total-title">合计：&nbsp;&nbsp;&yen;{{childfood.totalprice}} <input style="position:fixed;top:-1000px;left:-1000px;z-index:-9999" v-model='childfood.totalprice' type="text"></span>
...
export default {
  ...
  watch:{
    childfood:{
      ...
      // 　　　　　　　　　　　　alert(curVal.totalprice)
      // 　　　　　　　　　　　　alert(oldVal.totalprice)
                          this.childfood.totalprice=curVal.totalprice;
      　　　　　　　　　　},
      　　　　　　　　　　deep:true
　　}
  },
